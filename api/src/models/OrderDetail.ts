...
interface OrderDetailCreationAttributesI extends Optional<OrderDetailAttributesI, "id"> {}

export class OrderDetail extends Model<OrderDetailAttributesI, OrderDetailCreationAttributesI>
